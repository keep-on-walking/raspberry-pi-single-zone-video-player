...
# Video Player Service (no WantedBy to avoid ordering cycle)
...
# Video Player Timer (starts service 10s after boot to avoid ordering cycle)
...
echo "✅ Services enabled (video-player starts via timer)"
