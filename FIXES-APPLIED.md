...
- **Default:** 1920x1080 (forced in X11 for smooth performance)
- **Status:** Works reliably, can be changed to 4K if needed
- **Documentation:** See [RESOLUTION.md](RESOLUTION.md) for 4K setup guide
- **Note:** 1080p provides smooth playback without frame drops; 4K requires native 4K video files
